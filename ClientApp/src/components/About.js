...
export class About extends Component {
  ...
  render() {
    return (
        <div>
            <br></br>
            <h1 align="center" className="htext">Existing problem</h1>
            <br></br>
            ...
            <br></br>
            <h1 align="center" className="htext">We can fix it!</h1>
            <br></br>
        ...
        <p align="center">Our startup has a comfortable and wonderful design and is easy to use</p>
            ...
            <br></br>
            <br></br>
            <a href="CreateQueue.js" className="floating-button">Start</a>
            <br></br>
